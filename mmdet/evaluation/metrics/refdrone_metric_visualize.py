...
class RefDroneMetricVisualize(BaseMetric):
    ...
    def __init__(self,
                 ...
                 thresh_f1: float = 1.0,
                 save_dir: str = "./save_dir_ngdino_best",
                 **kwargs) -> None:
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        for result in results:
            ...
            # np.savetxt(os.path.join(self.save_dir, filename.split('.')[0]+'_'+text+'.txt'), filtered_boxes.numpy(), fmt='%.4f')
